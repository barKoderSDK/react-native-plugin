...
export class Barkoder {
  ...
  _emitCloseFromNative = () => {
    var _this$_closeCallback;
    (_this$_closeCallback = this._closeCallback) === null || _this$_closeCallback === void 0 ? void 0 : _this$_closeCallback.call(this);
  };
  ...
  getCurrentZoomFactor() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getCurrentZoomFactor(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  scanImage(base64, resultsCallback) {
    if (this.isAndroid()) {
      ...
      this._resultCallback = resultsCallback;
      this.startScanningEventEmmitter();
      NativeModules.BarkoderReactNativeViewManager.scanImage(findNodeHandle(this._barkoderViewRef.current), base64);
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
   ...
   */
  setRoiCenterMark(roiCenterMark) {
  ...
  getRoiCenterMark() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getRoiCenterMark(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
   ...
   */
  setReturnOnlyMatchedResults(enabled) {
  ...
  isPreviewMirrored() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isPreviewMirrored(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getMatchFilter() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getMatchFilter(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getReturnOnlyMatchedResults() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getReturnOnlyMatchedResults(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getLibVersion() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getLibVersion(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  isDatamatrixDpmModeEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isDatamatrixDpmModeEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  isQrDpmModeEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isQrDpmModeEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  setQrMultiPartMergeEnabled(enabled) {
  ...
  */
  isQrMultiPartMergeEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isQrMultiPartMergeEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  isQrMicroDpmModeEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isQrMicroDpmModeEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  isIdDocumentMasterChecksumEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isIdDocumentMasterChecksumEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  getScanningIndicatorColorHex() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getScanningIndicatorColorHex(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  setScanningIndicatorColor(hexColor) {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.setScanningIndicatorColor(findNodeHandle(this._barkoderViewRef.current), hexColor);
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  getScanningIndicatorWidth() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getScanningIndicatorWidth(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  getScanningIndicatorAnimation() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getScanningIndicatorAnimation(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  isScanningIndicatorAlwaysVisible() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isScanningIndicatorAlwaysVisible(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  ...
  setCamera(value) {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.setCamera(findNodeHandle(this._barkoderViewRef.current), value);
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  setARSelectedLocationColor(hexColor) {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.setARSelectedLocationColor(findNodeHandle(this._barkoderViewRef.current), hexColor);
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  setARNonSelectedLocationColor(hexColor) {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.setARNonSelectedLocationColor(findNodeHandle(this._barkoderViewRef.current), hexColor);
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
   ...
   */
  setARReturnOnlyMatchedResults(value) {
   ...
   */
  setARDisplayOnlyMatchedResults(value) {
  ...
  setARHeaderTextColorSelected(hexColor) {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.setARHeaderTextColorSelected(findNodeHandle(this._barkoderViewRef.current), hexColor);
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  setARHeaderTextColorNonSelected(hexColor) {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.setARHeaderTextColorNonSelected(findNodeHandle(this._barkoderViewRef.current), hexColor);
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
   ...
   */
  configureCloseButton(visible, positionX, positionY, iconSize, tintColor, backgroundColor, cornerRadius, padding, useCustomIcon, customIcon) {
    this._dispatchCommand('configureCloseButton', [visible, positionX, positionY, iconSize, tintColor, backgroundColor, cornerRadius, padding, useCustomIcon, customIcon]);
  }
   ...
   */
  configureFlashButton(visible, positionX, positionY, iconSize, tintColor, backgroundColor, cornerRadius, padding, useCustomIcon, customIconFlashOn, customIconFlashOff) {
    this._dispatchCommand('configureFlashButton', [visible, positionX, positionY, iconSize, tintColor, backgroundColor, cornerRadius, padding, useCustomIcon, customIconFlashOn, customIconFlashOff]);
  }
   ...
   */
  configureZoomButton(visible, positionX, positionY, iconSize, tintColor, backgroundColor, cornerRadius, padding, useCustomIcon, customIconZoomedIn, customIconZoomedOut, zoomedInFactor, zoomedOutFactor) {
    this._dispatchCommand('configureZoomButton', [visible, positionX, positionY, iconSize, tintColor, backgroundColor, cornerRadius, padding, useCustomIcon, customIconZoomedIn, customIconZoomedOut, zoomedInFactor, zoomedOutFactor]);
  }
  ...
  getShowDuplicatesLocations() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getShowDuplicatesLocations(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARMode() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARMode(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARResultDisappearanceDelayMs() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARResultDisappearanceDelayMs(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARLocationTransitionSpeed() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARLocationTransitionSpeed(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getAROverlayRefresh() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getAROverlayRefresh(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARSelectedLocationColor() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARSelectedLocationColor(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARNonSelectedLocationColor() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARNonSelectedLocationColor(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARSelectedLocationLineWidth() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARSelectedLocationLineWidth(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARNonSelectedLocationLineWidth() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARNonSelectedLocationLineWidth(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARLocationType() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARLocationType(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  isARDoubleTapToFreezeEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isARDoubleTapToFreezeEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  isARImageResultEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isARImageResultEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  isARBarcodeThumbnailOnResultEnabled() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.isARBarcodeThumbnailOnResultEnabled(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARResultLimit() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARResultLimit(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARContinueScanningOnLimit() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARContinueScanningOnLimit(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getAREmitResultsAtSessionEndOnly() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getAREmitResultsAtSessionEndOnly(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARReturnOnlyMatchedResults() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARReturnOnlyMatchedResults(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
   ...
   */
  getARDisplayOnlyMatchedResults() {
    if (this.isAndroid()) {
      const promiseRequestId = ++this._promiseRequestId;
      const promise = new Promise((resolve, reject) => {
        this._promisesMap.set(promiseRequestId, [resolve, reject]);
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARDisplayOnlyMatchedResults(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderHeight() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderHeight(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderShowMode() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderShowMode(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderMaxTextHeight() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderMaxTextHeight(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderMinTextHeight() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderMinTextHeight(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderTextColorSelected() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderTextColorSelected(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderTextColorNonSelected() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderTextColorNonSelected(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderHorizontalTextMargin() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderHorizontalTextMargin(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderVerticalTextMargin() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderVerticalTextMargin(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARHeaderTextFormat() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getARHeaderTextFormat(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  getPowerSavingMode() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getPowerSavingMode(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  getDeviceId() {
    if (this.isAndroid()) {
      ...
      return NativeModules.BarkoderReactNativeViewManager.getDeviceId(findNodeHandle(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
...
(function (_Barkoder) {
  ...
  let BarkoderRoiCenterMark = /*#__PURE__*/function (BarkoderRoiCenterMark) {
    ...
    return BarkoderRoiCenterMark;
  }({});
  _Barkoder.BarkoderRoiCenterMark = BarkoderRoiCenterMark;
  ...
  class DekoderConfig {
    ...
    toMap() {
      ...
      const map = {
        ...
        'OCR Text': (_this$ocrText2 = this.ocrText) === null || _this$ocrText2 === void 0 ? void 0 : _this$ocrText2.toMap(),
  ...
  _Barkoder.QRBarcodeConfig = QRBarcodeConfig;
