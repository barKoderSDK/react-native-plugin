  ...
  */
  ...
  getRoiCenterMark() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.getRoiCenterMark((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  isPreviewMirrored() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.isPreviewMirrored((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getMatchFilter() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.getMatchFilter((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getReturnOnlyMatchedResults() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.getReturnOnlyMatchedResults((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  isQrMultiPartMergeEnabled() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.isQrMultiPartMergeEnabled((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  ...
  getARReturnOnlyMatchedResults() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.getARReturnOnlyMatchedResults((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  getARDisplayOnlyMatchedResults() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.getARDisplayOnlyMatchedResults((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  getPowerSavingMode() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.getPowerSavingMode((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
  ...
  */
  getDeviceId() {
    if (this.isAndroid()) {
      ...
      return _reactNative.NativeModules.BarkoderReactNativeViewManager.getDeviceId((0, _reactNative.findNodeHandle)(this._barkoderViewRef.current));
    } else {
      throw new Error(OS_NOT_SUPPORTED);
    }
  }
